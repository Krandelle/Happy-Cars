        ...
        <div class="col-lg-12">
            ...
            <div class="col-md-6">
                <div class="card cars-list" data-id="<?php echo $row['id'] ?>">
                    <div class="cars-img">
                        <img src="<?php echo $fpath.$row['img_path'] ?>" alt="Car image">
                    </div>
                    <div class="card-body d-flex flex-column justify-content-center">
                        <p><strong><?php echo $row['brand'] ?> - <?php echo $row['model'] ?></strong></p>
                        ...
                        <div class="mt-2">
                            <button class="btn btn-primary btn-sm float-right book-cars" type="button" data-id="<?php echo $row['id'] ?>">Book Now</button>
                        </div>
                    </div>
                </div>
                <br>
